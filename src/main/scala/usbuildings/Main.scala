...
object Main extends CommandApp(
  //Name for runtime
  name = "cogsToGeotrellis",
  header = "",
  main = {
    ///Input Data Layer
    val nedOpt = Opts.option[String]("neds", help = "S3 URI prefix of input ned data").withDefault("s3://dewberry-demo/bats/dems/calTest")
    ///Output Data Layer
